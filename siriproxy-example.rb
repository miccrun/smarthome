...
class SiriProxy::Plugin::Example < SiriProxy::Plugin
  ...
  listen_for /what's my room temperature/i do
    content = open("https://home.micbase.com:11443/get.php",:ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read
    data = JSON.parse(content)
    temperature = data['temperature']
    humidity = data['humidity']
    say "Your roome temperature is #{temperature} degrees Celsius, relative humidity is #{humidity}%"

    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end

  listen_for /turn on my light/i do
    content = open("http://10.8.7.100/control.php?cmd=101",:ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read
    say "I have turn on your light"

    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end
  
  listen_for /turn off my light/i do
    content = open("http://10.8.7.100/control.php?cmd=102",:ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read
    say "I have turn off your light"

    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end

  listen_for /turn on my fan/i do
    content = open("http://10.8.7.100/control.php?cmd=103",:ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read
    say "I have turn on your fan"

    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end
  
  listen_for /turn off my fan/i do
    content = open("http://10.8.7.100/control.php?cmd=104",:ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read
    say "I have turn off your fan"
